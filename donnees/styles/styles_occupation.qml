...
<qgis version="2.2.0-Valmiera" minimumScale="0" maximumScale="250001" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 attr="THEME09" symbollevels="0" type="categorizedSymbol">
    <categories>
      ...
      <category symbol="2" value="PRAIRIES" label="PRAIRIES"/>
      <category symbol="3" value="SURFACES EN EAU" label="SURFACES EN EAU"/>
    ...
    <symbols>
      ...
      <symbol alpha="1" type="fill" name="3">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_unit" v="MM"/>
          <prop k="color" v="142,193,221,255"/>
          <prop k="color_border" v="0,0,0,255"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="style" v="solid"/>
  ...
  <edittypes>
    ...
    <edittype labelontop="0" editable="1" type="0" name="NIV1BIS"/>
    <edittype labelontop="0" editable="1" type="0" name="OCSGEN09_1"/>
    <edittype labelontop="0" editable="1" type="0" name="OCSGEN09_M"/>
